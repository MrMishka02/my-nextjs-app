...
function Card({ path, cardH1, cardText, cardLink }: Props) {
  return (
    <div
      className="w-[24rem] h-[34rem] drop-shadow-md bg-white rounded-lg ml-2 mr-2 mt-20 mb-10 pt-2
      select-none hover:opacity-[0.8] lg:mb-0 sm:w-[20rem] sm:mb-0 sm:mr-0 sm:ml-0"
    >
